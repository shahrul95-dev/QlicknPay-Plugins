...
<div id="content">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-cod" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="Qlicknpay_merchant_id" value="<?php echo $Qlicknpay_merchant_id; ?>" placeholder="<?php echo $Qlicknpay_merchant_id; ?>" id="input-total" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-total"><span data-toggle="tooltip" title="<?php echo $help_API; ?>"><?php echo $entry_API; ?></span></label>
                        <div class="col-sm-10">
                            <input type="text" name="Qlicknpay_API" value="<?php echo $Qlicknpay_API; ?>" placeholder="<?php echo $Qlicknpay_API; ?>" id="input-total" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <label class="col-sm-2 control-label" for="input-sort-order"><?php echo $entry_sort_order; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="Qlicknpay_sort_order" value="<?php echo $Qlicknpay_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
